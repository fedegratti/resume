...
#oneline-title-item(
  title: "Skills",
  content: [Ruby, JavaScript, TypeScript, SQL, Ruby on Rails, React.js, Next.js, AWS, Docker, PostgreSQL, Redis, Sidekiq, WebSockets, REST, GraphQL, RSpec, TDD, Design Patterns, OOP, MVC, Code Review, Scrum],
)
